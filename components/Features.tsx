...
const features = [
  ...
  {
    name: 'Arbiter Forms',
    href: '/features/arbiter-forms',
    desc: 'Create and track forms and check sheets for RFIs, Toolbox Talks, Safety Meetings, Vendor Orientation, meetings, and action items.',
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
